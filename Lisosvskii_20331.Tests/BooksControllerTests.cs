using Lisovskii_20331.API.Controllers;
...
namespace Lisosvskii_20331.Tests
{
    public class BooksControllerTests : IDisposable
    {
        ...
        public BooksControllerTests()
        {
            ...
            var categories = new Genre[]
               {
                    new Genre {Name="", NormalizedName="Romance"},
                    new Genre {Name="", NormalizedName="Manga"}
               };
            ...
            {
                new Book {Name="", Description="", Pages=0,
                    Genre=categories
                        .FirstOrDefault(c=>c.NormalizedName.Equals("Romance"))},
                new Book {Name = "", Description="", Pages=0,
                    Genre=categories
                        .FirstOrDefault(c=>c.NormalizedName.Equals("Romance"))},
                new Book {Name = "", Description="", Pages=0,
                    Genre=categories
                        .FirstOrDefault(c=>c.NormalizedName.Equals("Manga"))},
                new Book {Name = "", Description="", Pages=0,
                    Genre=categories
                        .FirstOrDefault(c=>c.NormalizedName.Equals("Manga"))},
                new Book {Name = "", Description="", Pages=0,
        ...
        public async void ControllerFiltersCategory()
        {
            ...
            var category = context.Genres.First();
            ...
            //assert 
            Assert.True(dishesList.All(d => d.GenreId == category.Id));
        }
